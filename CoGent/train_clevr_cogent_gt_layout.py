...
exp_name = "clevr_cogent_gt_layout"
snapshot_dir = '/data/CLEVR_CoGenT_v1.0/exp/exp_clevr/tfmodel/%s/' % exp_name

# Log params
log_interval = 20
log_dir = '/data/CLEVR_CoGenT_v1.0/exp/exp_clevr/tb/%s/' % exp_name
...
imdb_file_trn = '/data/CLEVR_CoGenT_v1.0/imdb/imdb_trnA.npy'
imdb_file_tst = '/data/CLEVR_CoGenT_v1.0/imdb/imdb_valA.npy'
