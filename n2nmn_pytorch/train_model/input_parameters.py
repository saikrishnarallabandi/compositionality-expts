...
vocab_captions_file = os.path.join(data_dir, 'vocab_captions_vqa.txt')
...
## VQA
imdb_file_trn = os.path.join(data_dir, 'imdb/imdb_train2014.npy')
imdb_file_tst = os.path.join(data_dir, 'imdb/imdb_val2014.npy')
