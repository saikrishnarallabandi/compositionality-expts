...
class SceneModule(nn.Module):
    ...
    def forward(self, input_image_feat, input_text, input_image_attention1=None, input_image_attention2=None):
        input_image_feat = input_image_feat.permute(0, 3, 1, 2)
...
class FindSamePropertyModule(nn.Module):
    ...
    def forward(self, input_image_feat, input_text, input_image_attention1=None, input_image_attention2=None):
        ...
        x = input_image_feat.permute(0, 3, 2, 1)
        image_mapped = self.conv1(x)  # (N, map_dim, H, W)
...
class AndModule(nn.Module):
    ...
    def forward(self, input_image_feat, input_text, input_image_attention1=None, input_image_attention2=None):
        if input_image_attention1.size(2) != 14 :
            input_image_attention1 = input_image_attention1.permute(0,1,3,2)

        if input_image_attention2.size(2) != 14 :
            input_image_attention2 = input_image_attention2.permute(0,1,3,2)
