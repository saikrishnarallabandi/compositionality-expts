...
def get_loader(transform,mode="train",batch_size=1,vocab_threshold=None,vocab_file="./vocab.pkl", start_word="<start>",end_word="<end>",
                                              unk_word="<unk>",vocab_from_file=True,num_workers=0,cocoapi_loc="/home/ubuntu/captions/", test=False):
    ...
    dataset = CoCoDataset(transform=transform,mode=mode,batch_size=batch_size,vocab_threshold=vocab_threshold,vocab_file=vocab_file,start_word=start_word,
					end_word=end_word,unk_word=unk_word,annotations_file=annotations_file,vocab_from_file=vocab_from_file,img_folder=img_folder, test=test)
...
class CoCoDataset(data.Dataset):
    ...
    end_word, unk_word, annotations_file, vocab_from_file, img_folder, test=False):
    ...
    def __getitem__(self, index):
        if self.mode == "train"  or self.mode == "val":
            ...
            print("Original caption: ", caption, self.mode)
            #if self.test:  
            #    return image, path
            #else :
