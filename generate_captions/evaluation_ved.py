...
def main(args):
    ...
    # Build models
    decoder = CaptionRNN_VI(args.feature_size, args.embed_size_image, args.embed_size, args.hidden_size, len(vocab), args.num_layers).eval() ## Batch norm
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_path', type=str, default='./models_ved_exp/decoder-30-600.ckpt', help='path for trained decoder')
