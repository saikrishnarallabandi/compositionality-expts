...
def main(args):
    ...
    # Build models
    decoder = CaptionRNN(args.feature_size, args.embed_size, args.hidden_size, len(vocab), args.num_layers).eval() ## Batch norm
...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_path', type=str, default='./models/decoder-10-600.ckpt', help='path for trained decoder')
