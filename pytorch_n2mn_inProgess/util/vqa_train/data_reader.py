...
class BatchLoaderVqa:
    ...
    def load_one_batch(self, sample_ids):
        ...
        if self.load_gt_layout:
            ...
            gt_layout_batch_lens = np.zeros((1, actual_batch_size), np.int32)
        ...
        for n in range(len(sample_ids)):
            ...
            if self.load_gt_layout:
                ...
                gt_layout_batch[:, n] = self.assembler.module_list2tokens(gt_layout_tokens, self.T_decoder)
                gt_layout_batch_lens[0, n] = len(gt_layout_tokens) + 1
        ...
        if self.load_gt_layout:
            ...
            batch['gt_layout_batch_lens'] = gt_layout_batch_lens
        if self.load_gt_txtatt:
